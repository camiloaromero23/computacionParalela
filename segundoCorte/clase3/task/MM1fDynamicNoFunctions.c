...
#pragma omp for
    for (i = 0; i < MATRIX_SIZE; i++)
    {
      for (j = 0; j < MATRIX_SIZE; j++)
      {
        ...
        auxMatrixB = *(transposeMatrixB + j); // Assignment of the position of the transposeMatrixB in the main array for looping in it
